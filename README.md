...
|:---:|:---:|
| <img src="https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=H1z3-br0&theme=github_dark&hide_border=true" width="200%" /> | ![Trophy](https://github-profile-trophy.vercel.app/?username=h1z3&theme=matrix&no-frame=true&no-bg=true&margin-w=4&column=4) |
...
![Snake eating my contributions](https://raw.githubusercontent.com/h1z3/h1z3/output/snake.svg)

```diff
  Report filed by:   4x10m Intelligence Division
! Classification:    TOP SECRET // REL TO CTF PLAYERS
  Distribution:      Team leads only
  Destruction:       Burn after reading. Or don't. Markdown doesn't burn.
```
